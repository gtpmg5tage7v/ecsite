    ...
    <header class="header">
        ...
        <div class="top_bar">
            <div class="container">
             ...
             <div class="top_bar_menu">
              <ul class="standard_dropdown top_bar_dropdown">
                  ...
                  <li> 
            <a href="" data-toggle="modal" data-target="#exampleModal">オーダートラッキング</a>                   
                  </li>
                ...
                @endphp
                                ...
                                @if(Session()->get('lang') == 'hindi' )
                                 <a href="{{ route('language.english') }}">日本語<i class="fas fa-chevron-down"></i></a>
                                @else
           ...
           <a href="{{ route('home') }}"><div class="user_icon"><img src="{{ asset('frontend/images/user.svg')}}" alt=""></div> プロフィール<i class="fas fa-chevron-down"></i></a>
                                        <ul>
                                            <li><a href="{{ route('user.wishlist') }}">お気に入り登録リスト</a></li>
                                            <li><a href="{{ route('user.checkout') }}">お会計</a></li>
                                            {{-- <li><a href="#">その他</a></li> --}}
                                        </ul>
                                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ url('/') }}"><img src="{{ asset('frontend/images/logo2.jpg')}}" alt=""></a></div>
                        </div>
                    </div>
  ...
  $category = DB::table('categories')->get();
   @endphp
                ...
                <form  method="post" action="{{ route('product.search') }}" class="header_search_form clearfix">
                    @csrf
   <input type="search" required="required" class="header_search_input" placeholder="商品を検索する..." name="search">
                    <div class="custom_dropdown">
                        <div class="custom_dropdown_list">
                            <span class="custom_dropdown_placeholder clc">すべてのカテゴリー</span>
         ...
         $wishlist = DB::table('wishlists')->where('user_id',Auth::id())->get();
               @endphp
                                ...
                                <div class="wishlist_content">
                                    <div class="wishlist_text"><a href="#">お気に入り</a></div>
                            ...
                            <div class="cart">
                                <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                    ...
                                    <div class="cart_content">
                                        <div class="cart_text">カート</div>
                                        <div class="cart_price">￥{{ number_format(Cart::subtotal()) }}</div></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 footer_col">
                    <div class="footer_column footer_contact">
                        ...
                        <div class="footer_title">ご質問はこちら(平日10時～18時)</div>
                ...
                <div class="col-lg-2">
                    <div class="footer_column"> 
                        <ul class="footer_list footer_list_2">
                            ...
                            <li><a href="#">特定商取引に関する法律に基づく表示</a></li>
                            <li><a href="#">Q&A</a></li>
                            <li><a href="#">お問い合わせ</a></li>
                            @if (Auth::id())
                            <li><a href="{{ route('deactive.form') }}">退会</a></li>
                            @endif
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">お客様のステータスコード</h5>
   ...
   <form method="post" action="{{ route('order.tracking') }}">
    ...
    <div class="modal-body">
     ...
     <button class="btn btn-danger" type="submit">今すぐ追跡 </button>  

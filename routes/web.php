...
Route::get('admin', 'Admin\LoginController@showLoginForm')->name('admin.login')->middleware('ip_address');
...
Route::post('user/ondelivery/charge/', 'PaymentController@OnDelivery')->name('ondelivery.charge');  
